...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('customslider');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Allin\Customslider\Model\Customslider')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('customslider/*/index');
    }
