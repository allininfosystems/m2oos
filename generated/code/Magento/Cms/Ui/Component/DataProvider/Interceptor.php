...
class Interceptor extends \Magento\Cms\Ui\Component\DataProvider implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'prepareMetadata');
        if (!$pluginInfo) {
            return parent::prepareMetadata();
        } else {
            return $this->___callPlugins('prepareMetadata', func_get_args(), $pluginInfo);
        }
    }
